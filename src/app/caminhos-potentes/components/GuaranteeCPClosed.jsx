...
const barcode = "/assets/icons/icon-barcode.png";
const mastercard = "/assets/icons/icon-mastercard.png";
const paypal = "/assets/icons/icon-paypal.png";
const pix = "/assets/icons/icon-pix.png";
const visa = "/assets/icons/icon-visa.png";
      ...
      <div className={styles.gridWrap}>
        <div className={styles.guarateeGrid}>
          <div className={styles.guaranteeGridLeft}>
            <h2>O que você ganha ao entrar no Caminhos Potentes Teste</h2>
            ...
            <p className={styles.closed}>INSCRIÇÕES ENCERRADAS</p>
